...
Hub-local copy (same behavior as the DNR viewer repo). If the resolution rules
change there, update this file here — do not import across repositories.
"""
...
def resolve_dnr_full_wells_csv(out_dir: str, explicit: str | None) -> str:
    ...
    raise FileNotFoundError(
        ...
        "Commit or copy the .gz from the viewer repo, or set DNR_FULL_CSV."
    )
