/**
 * FROZEN SNAPSHOT — DNR well classification v1 (pre dual-label overhaul).
 *
 * Do not edit this file except for archival notes. It is the revert target when
 * NEXT_PUBLIC_DNR_CLASSIFY_VERSION=v1 (or DNR_CLASSIFY_VERSION=v1).
 *
 * Snapshot date: 2026-07-21
 * Source: apps/hub/src/lib/dnr-well-classify.ts (pre-v2 dual-label)
 *
 * Known v1 limitations (why v2 exists):
 * - Estimated/unverified locations short-circuit before rock vs unconsolidated.
 * - Unconsolidated detection uses only aquifer text (no lithology).
 * - Rock top is never evaluated; "rock" is residual after simple uncon text match.
 *
 * Revert: see docs/DNR_CLASSIFY_REVERT.md
 */
