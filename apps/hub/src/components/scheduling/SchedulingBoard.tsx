    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm text-zinc-600 dark:text-zinc-300">
          ...
          day (no clock slots). Use week and month horizons for work booked far out,
          then open a job for a live multi-source forecast and field-specific
          considerations — especially when the rig is far off the drive.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-xl border border-zinc-200 bg-zinc-50/80 p-4 dark:border-zinc-700 dark:bg-zinc-900/40">
        ...
        <button
          type="button"
          className="ml-auto rounded-lg bg-red-600 px-3 py-2 text-sm font-medium text-white hover:bg-red-700"
